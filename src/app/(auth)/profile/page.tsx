...
export default function ProfilePage() {
  ...
  const uploadKyc = async () => {
    ...
    if (!kycFile && !licenseFile) {
      showToast("Select at least one document", false);
      return;
    }
          ...
          <div className="rounded-xl bg-popover shadow-soft p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex">
                  <span className="inline-flex items-center px-4 bg-muted border border-r-0 border-input rounded-l-lg font-body text-sm text-muted-foreground">
                    +91
                  </span>
                  <input
                    value={form.phone}
              ...
              <div>
                ...
                <div className="flex">
                  ...
                  <input
                    ...
                    className="input rounded-l-none"
                    placeholder="10-digit number (for tenant contact)"
                    maxLength={10}
                  />
                </div>
              </div>
              ...
              {profile?.kycStatus === "APPROVED" ? (
                <div className="rounded-lg bg-success/8 border border-success/20 p-4 flex items-center gap-3">
                  ...
                  <p className="font-body text-sm text-success font-medium">
                    Your identity has been verified. Your listings show a
                    Verified badge.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <p className="font-body text-sm text-muted-foreground">
                    Upload your Aadhaar / PAN and PG registration certificate.
                    KYC-verified owners get a badge on all listings and higher
                    tenant trust.
                  </p>
                  <div className="space-y-3">
                    <div>
                  ...
                  {profile?.kycStatus === "REJECTED" && (
                    <div className="rounded-lg bg-destructive/8 border border-destructive/20 p-3 mt-2">
                      <p className="font-body text-sm text-destructive">
                        Previous submission was rejected. Please re-upload
                        clearer documents.
                      </p>
                    </div>
                  )}
