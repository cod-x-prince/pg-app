            ...
            <dl className="space-y-0 divide-y divide-border">
              {[
                ...
                >
                  ...
                  <dd className="font-display font-semibold text-sm text-foreground">
                    {item.value}
                  </dd>
                </div>
              ))}
              ...
              {profile?.kycStatus === "APPROVED" ? (
                ...
                <div className="space-y-5">
                  <p className="font-body text-sm text-muted-foreground leading-relaxed">
                    Upload your Aadhaar or PAN card and optionally your PG
                    registration certificate. KYC-verified owners get a badge on
                    all listings and higher tenant trust.
                  </p>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="font-display text-sm font-medium text-foreground block mb-2">
                        ...
                        <span className="font-body font-normal text-muted-foreground ml-1">
                          (Aadhaar / PAN)
                        </span>
                      </label>
                      <input
