...
export default async function PropertyDetailPage({
  ...
  const minRent = property.rooms.length
    ? Math.min(...property.rooms.map((r: { rent: number }) => r.rent))
    : null;
      ...
      <div className="pt-16 min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <nav className="text-xs text-gray-400 mb-6 flex items-center gap-1.5">
            <a href="/" className="hover:text-[#1B3B6F] transition-colors">
              Home
            </a>
            <span>/</span>
            <a
              href={`/properties/${params.city}`}
              className="hover:text-[#1B3B6F] transition-colors capitalize"
            >
              {params.city}
            </a>
            <span>/</span>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 space-y-8 min-w-0">
                ...
                <div className="flex flex-wrap items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      ...
                      <span className={`badge text-xs ${gender.style}`}>
                        {gender.label}
                      </span>
                      {availableCount > 0 ? (
              ...
              {property.description && (
                <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-card">
                  <h2 className="font-serif text-xl font-semibold text-[#1B3B6F] mb-3">
                    About this PG
                  </h2>
              ...
              {property.amenities.length > 0 && (
                <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-card">
                  <h2 className="font-serif text-xl font-semibold text-[#1B3B6F] mb-4">
                    Amenities
                  </h2>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400">
                            Security deposit: ₹{room.deposit.toLocaleString()}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <p className="font-serif font-semibold text-[#1B3B6F] text-lg">
                            ₹{room.rent.toLocaleString()}
                          </p>
                          <p className="text-xs text-gray-400">per month</p>
                        </div>
                        <span
                          className={`badge text-xs ${room.isAvailable ? "bg-green-50 text-green-700" : "bg-red-50 text-red-500"}`}
                        >
              ...
              {property.lat && property.lng && (
                <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-card">
                  ...
                  >
                    ...
                    <svg
                      className="w-4 h-4 text-[#1B3B6F]/50 group-hover:translate-x-0.5 transition-transform"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <div className="flex items-center justify-between mb-5">
                  <h2 className="font-serif text-xl font-semibold text-[#1B3B6F]">
                    ...
                    {property.reviews.length > 0 && (
                      <span className="ml-2 text-base font-sans font-normal text-gray-400">
                        ({property.reviews.length})
                      </span>
                    )}
                  </h2>
                  {avgRating > 0 && (
                    <div className="flex items-center gap-2 bg-[#EEF3FB] px-4 py-2 rounded-xl">
                      <span className="font-serif text-2xl font-semibold text-[#1B3B6F]">
                        {avgRating.toFixed(1)}
                      </span>
                      <div>
                ...
                {property.reviews.length === 0 ? (
                  <div className="text-center py-10 bg-gray-50 rounded-xl">
                    <p className="text-gray-400 text-sm">
                      No reviews yet. Book a stay and share your experience!
                    </p>
                  </div>
                ) : (
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-card">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      PG Owner · Responds via WhatsApp
                    </p>
                  </div>
                </div>
              </div>
