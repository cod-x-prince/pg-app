    ...
    <main><div className="min-h-screen flex bg-background">
      ...
      <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden">
        <Image
          ...
          alt="Warm home" fill priority className="object-cover"
        />
        ...
        <div className="relative z-10 flex flex-col justify-between p-14 w-full">
          ...
          <div>
            ...
            <p className="font-body text-white/60 text-base mb-10 leading-relaxed">
              Thousands of verified PGs across India. Zero broker, direct booking.
            </p>
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div key={s.label} className="rounded-xl p-4"
                  ...
                  <p className="font-display font-bold text-2xl text-white tabular-nums">{s.value}</p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[400px]">
          ...
          <Link href="/" className="flex items-center gap-2 mb-8 lg:hidden">
            ...
            <span className="font-display font-bold text-lg text-foreground">PGLife</span>
          </Link>
          ...
          <div className="mb-8">
            ...
            <p className="font-body text-sm text-muted-foreground">Sign in to your account to continue</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="font-display text-sm font-medium text-foreground">Password</label>
