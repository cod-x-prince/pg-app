    ...
    <>
      ...
      <div className="pt-16 min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-3xl shadow-card max-w-sm w-full p-10 text-center">
          ...
          <h1 className="font-serif text-2xl font-semibold text-[#1B3B6F] mb-2">Page Error</h1>
          <p className="text-gray-400 text-sm mb-6">Something went wrong loading your dashboard.</p>
