...
### Minimal Dynamic Context Skill
```markdown
---
name: pr-summary
description: Summarize the current PR changes. Use when the user wants a PR overview or summary of changes.
---
...
Analyze the changes above and provide a clear summary covering:
1. What changed and why (infer from commit messages and code)
2. Risk areas or potential issues
