...
export const metadata: Metadata = {
  ...
  description: "India's trusted PG booking platform. Verified listings, real photos, direct booking. Zero broker fees.",
  openGraph: {
...
export const viewport: Viewport = {
  width: "device-width", initialScale: 1, themeColor: "#f5f0eb",
}
